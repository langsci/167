...
The pages will be typeset only after proofreading. This means that you will find widows and orphans, and examples split over two pages. There is no need to mark those specifically; we will take care of them during typesetting.
...
This text colleciton is a novel type of publication for us, so if you have any additional comments or remarks about this book and its setup, please let us know. 
